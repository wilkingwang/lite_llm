...
const std::vector<std::pair<uint32_t, uint16_t>> gUnicodeRangesFlags = {
...
const std::unordered_set<uint32_t> gUnicodeSetWhitespace = {
    0x000009,
    0x00000A,
    0x00000B,
    0x00000C,
...
const std::unordered_map<uint32_t, uint32_t> gUnicodeMapLowercase = {
    {0x000041, 0x000061},
    {0x000042, 0x000062},
    {0x000043, 0x000063},
    {0x000044, 0x000064},
...
const std::unordered_map<uint32_t, uint32_t> gUnicodeMapUppercase = {
    {0x000061, 0x000041},
    {0x000062, 0x000042},
    {0x000063, 0x000043},
    {0x000064, 0x000044},
...
const std::vector<comm::NFDRange> gUnicodeNFDRanges = {
    // start, last, nfd
